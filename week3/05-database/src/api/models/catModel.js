...
const getOwnerName = async (id) => {
  try {
    ...
    if (rows.length === 0) {
      throw new Error('User not found');  // You can customize this message or return a specific code
    }
...
export {listAllCats, findCatById, addCat, modifyCat, removeCat, findCatByOwnerId, getOwnerName};